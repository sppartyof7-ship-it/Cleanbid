...
const BASE_CONFIG = {
  ...
  services: [
      ...
      windowTypes: [
        {
          ...
          priceByPackage: { standard: 7, premium: 12, platinum: 18 },
        },
        {
          ...
          priceByPackage: { standard: 10, premium: 16, platinum: 22 },
        },
        {
          ...
          priceByPackage: { standard: 18, premium: 28, platinum: 38 },
        },
      ],
      extras: [
    ...
    },
    {
      ...
      tiers: [
        { id: "basic", label: "Basic Install", perLinFt: 12.99, description: "Guard installation only" },
        { id: "with_cleaning", label: "Install + Gutter Cleaning", perLinFt: 17.99, description: "Includes full gutter cleaning before install" },
        { id: "full_service", label: "Full Service", perLinFt: 22.99, description: "Gutter cleaning, guard install & downspout work" },
      ],
      extras: [],
    },
  ],
