...
const BASE_CONFIG = {
  ...
  services: [
    ...
    },
    {
      ...
      tiers: [
        { id: "basic", label: "Basic Install", perLinFt: 10.99, description: "Guard installation only" },
        { id: "with_cleaning", label: "Install + Gutter Cleaning", perLinFt: 15.99, description: "Includes full gutter cleaning before install" },
        { id: "full_service", label: "Full Service", perLinFt: 20.99, description: "Gutter cleaning, guard install & downspout work" },
      ],
      extras: [],
    },
  ],
